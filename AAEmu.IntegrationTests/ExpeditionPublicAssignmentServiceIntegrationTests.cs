    ...
    : IClassFixture<ExpeditionRecruitmentMySqlFixture>
{
    ...
    private static QuestTemplate QuestTemplate()
    {
        ...
        reward.ActTemplates.Add(new QuestActSupplyExpeditionExp(reward) { Point = checked((int)Reward) });
        reward.ActTemplates.Add(new QuestActSupplyContributionPoint(reward) { Point = checked((int)Reward) });
