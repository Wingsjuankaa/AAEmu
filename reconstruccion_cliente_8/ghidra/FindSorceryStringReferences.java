...
// Kept separate from the generic helper so headless runs can compile it with
// the Java runtime bundled for the active Ghidra installation.
// Usage: FindSorceryStringReferences.java <fragment> [<fragment> ...]
// @category AA8
...
public class FindSorceryStringReferences extends GhidraScript {
    @Override
    public void run() throws Exception {
        ...
        for (String rawFragment : args) {
            ...
            println("=== SORCERY_STRINGS_MATCHING " + rawFragment + " ===");
            int strings = 0;
            int references = 0;
