...
public class Aa10IpnyaNativeAudit extends GhidraScript {
    public void run() throws Exception {
        ...
        Set<String> terms=Set.of("StartReinforceLevelup","StartReinforceAddExp","ChangeLevelEffect","SuitableLevelForEquipSlotReinforce","equipSlotEnchantment","equipSlotFormulaItemLevel","equipSlotBundleEffect");
