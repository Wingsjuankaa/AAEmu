// Read-only provenance gate for the existing Smelting selector decompilation.
// @category AA10
...
public class Aa10SmeltingSelectorAudit extends GhidraScript {
    @Override
    public void run() throws Exception {
        ...
        try {
            ...
            for (String address : new String[] {"3998b9c0", "39af6140", "39121180"}) {
