    ...
    : GamePacket(SCOffsets.X2EnterWorldResponsePacket, 5)
{
    public override PacketStream Write(PacketStream stream)
    {
        ...
        // makes character creation require the engine's editor mode (dev RVA 0x4F18B0;
        // release RVA 0x356D20). Sending access level 100 | 1 silently blocks normal GM
        // clients before CSCreateCharacter. Keep the retail connection authority;
