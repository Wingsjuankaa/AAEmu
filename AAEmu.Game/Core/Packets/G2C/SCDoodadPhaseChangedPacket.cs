...
public class SCDoodadPhaseChangedPacket : GamePacket
{
    ...
    public SCDoodadPhaseChangedPacket(Doodad doodad, uint personalPhase) : this(doodad)
    {
    ...
    public override PacketStream Write(PacketStream stream)
    {
        ...
        stream.Write(_personalPhase ?? _doodad.FuncGroupId);
        ...
        stream.Write(_personalPhase.HasValue ? 0u : _doodad.ItemTemplateId);
