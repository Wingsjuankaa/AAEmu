...
public static class SensitiveOperationGuard
{
    ...
    public static bool TrySetProtection(Character character, bool protect, out string refusal)
    {
        ...
        if (!IsEnabled)
        {
            refusal = "La protección de operaciones sensibles está desactivada en este servidor.";
            return false;
        }
        ...
        {
            refusal = "Primero configura una segunda contraseña para verificar la cuenta protegida.";
            return false;
        }
    ...
    public static bool MayPerform(Character character, SensitiveOperationKind kind, out string reason)
    {
        ...
        reason = "Tu cuenta está protegida: introduce la segunda contraseña antes de realizar esta acción.";
        return false;
    }
