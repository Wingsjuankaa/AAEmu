    ...
    public UnitReqsValidationResult Validate(BaseUnit owner, BaseUnit target, Item targetItem = null)
    {
        ...
        switch (KindType)
        {
            ...
            case UnitReqsKindType.AreaSphere:
                ...
                return RetWithValue(SkillResultKeys.skill_urk_area_sphere, Value1, SphereGameData.Instance.IsInsideAreaSphere(Value1, Value2, owner?.Transform?.World?.Position ?? Vector3.Zero, worldName: owner?.ParentWorld?.Template.Name) != null);
