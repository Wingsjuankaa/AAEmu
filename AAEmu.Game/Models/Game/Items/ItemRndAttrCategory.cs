...
public class ItemRndAttrCategory
{
    ...
    public int MaxEvolvingGrade { get; set; } = -1;
    ...
    /// <remarks>
    /// This reports whether the current bar can still accept EXP. Grade promotion is separately capped
    /// by <c>max_evolving_grade</c>: a Hiram tier can fill the bar at its terminal grade without being
    /// promoted into the grade reserved for the next awakened tier.
    /// </remarks>
