...
public static class BuffTriggerKindRules
{
    ...
    [
        ...
        new(BuffEventTriggerKind.Breaker, 31, "breaker", BuffTriggerWiring.BuffEvent,
            "the native buff_breakers evaluator raises OnBreaker once its authored tag conjunction matches"),
