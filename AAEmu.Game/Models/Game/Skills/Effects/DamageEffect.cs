...
public class DamageEffect : EffectTemplate
{
        ...
        CompressedGamePackets packetBuilder = null)
    {
        ...
        // AoE decay remains deferred: upstream guessed a ten-second lifetime.
        ...
        switch (hitType)
        {
            case SkillHitType.MeleeCritical:
                finalDamage *= DamageEffectRules.CriticalFactorFromReduction(
                    ((Unit)caster).MeleeCriticalBonus, CriticalBonus, flexibilityBonusReduction);
                break;
            case SkillHitType.RangedCritical:
                finalDamage *= DamageEffectRules.CriticalFactorFromReduction(
                    ((Unit)caster).RangedCriticalBonus, CriticalBonus, flexibilityBonusReduction);
                break;
            case SkillHitType.SpellCritical:
                finalDamage *= DamageEffectRules.CriticalFactorFromReduction(
                    ((Unit)caster).SpellCriticalBonus, CriticalBonus, flexibilityBonusReduction);
                break;
            default:
                break;
        }
        ...
        if (ManaDamage)
            ...
            trg.ReduceCurrentHp(caster, value, damageType: DamageType);
