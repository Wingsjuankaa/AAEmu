...
public static class DamageEffectRules
{
    ...
    public static float CriticalFactor(float unitCriticalBonus, int effectCriticalBonus, float victimFlexibility) =>
        CriticalFactorFromReduction(unitCriticalBonus, effectCriticalBonus, victimFlexibility / 100f);

    public static float CriticalFactorFromReduction(float unitCriticalBonus, int effectCriticalBonus, float reduction) =>
        1f + ((unitCriticalBonus + effectCriticalBonus) - reduction) / 100f;
