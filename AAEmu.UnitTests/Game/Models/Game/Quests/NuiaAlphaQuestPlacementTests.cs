...
public class NuiaAlphaQuestPlacementTests
{
    [Test]
    public async Task Catalog_PreservesAllNativePlacementsIncludingTiltScaleAndStartPhase()
    {
        ...
        var fixture = Path.Combine(repo!.FullName, "AAEmu.UnitTests", "Fixtures", "nuia_alpha_r575_placements.csv");
        var path = Path.Combine(repo.FullName, "AAEmu.Game", "Data", "Worlds", "main_world",
            "doodad_spawns_aa10_nuia_alpha_r575.json");
        ...
        await Assert.That(actors.Count).IsEqualTo(270);
