...
public class FeatureSetTests
{
    ...
    [Arguments(Feature.itemSecure, 5, 0x20)]
    ...
    [Arguments(Feature.account_attendance, 18, 0x01)]
    [Arguments(Feature.itemLookConvertInBag, 18, 0x10)]
    [Arguments(Feature.lootGacha, 20, 0x01)]
